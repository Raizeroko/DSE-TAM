...
class PatchEmbedding(nn.Module):
    def __init__(self, emb_size=40, n_chan=22):
...
class Conformer(nn.Sequential):
    def __init__(self, emb_size=40, depth=6, n_classes=4, n_chan=22, n_hidden=2440, **kwargs):
        super().__init__(
...
if __name__ == '__main__':
    ...
    net = Conformer(n_classes=2, n_chan=32, n_hidden=800).cuda()
