...
class ACRNN_DREAMER(nn.Module):
    def __init__(self,input_height):
        super(ACRNN_DREAMER,self).__init__()
        self.H = 1
        # self.W = 128
        self.W = 384
        self.C = input_height
        ...
        # self.kernel_height = 32   # DEAP
        self.kernel_height = 14   # DREAMER
        # self.kernel_height = 62     # SEED
        self.kernel_width = 45
        self.kernel_stride = 1
        self.pooling_height = 1
        self.pooling_width = 25
...
if __name__ == '__main__':
    x = torch.randn(64, 14, 384)
    model = ACRNN_DREAMER(14)
