...
Some of the source code originates from [IJCNN](https://github.com/ynulonger/ijcnn), [PR-PL](https://github.com/KAZABANA/PR-PL), and [ACRNN (PyTorch)](https://github.com/nayuta-ai/ACRNN_EEG).

We extend our sincere gratitude to the authors of the aforementioned code for their valuable contributions.
